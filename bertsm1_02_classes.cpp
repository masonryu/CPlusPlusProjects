...
/* 
	Program Description:
		The purpose of this program is to prompt the user for account information, then print out the information they give us, open an account for them, then close the account.
*/
...
// Members of class
	...
	void displayCustomer() {
		...
		cout << endl ;
		cout << "estimated amount year from now: " << amount +amount*interestRate/100 << endl ;
...
// Deconstructor
	~bankAccount() {
		cout  << endl << "Closing the account: " << accountNumber << ", " << firstName << ", "
			 << lastName << ", with the amount " << amount ;
	} ;
} ;
...
cout << endl  << "CUSTOMERS SUMMARY" << endl ;
